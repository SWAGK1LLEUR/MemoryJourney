...
using UnityEngine;
using UnityEditor;
[CustomEditor(typeof(StarterAssets.FirstPersonController))]
public class PlayerPov : Editor
{
    private void OnSceneGUI()
    {
        StarterAssets.FirstPersonController fov = (StarterAssets.FirstPersonController)target;
        Handles.color = Color.blue;
        Handles.DrawWireArc(fov._mainCamera.transform.position, Vector3.up, Vector3.forward, 360, 50);
